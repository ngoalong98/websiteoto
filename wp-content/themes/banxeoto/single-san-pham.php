						...
						<div class="row">
									...
									<?php foreach ($gallery as $key => $value) { ?>
										<li data-thumb="<?php echo $value['sizes']['thumbnail'];?>" data-src="<?php echo $value['url'];?>">
											<div class="img-height">
												...
												<div class="overlay">
													<a href="<?php the_permalink();?>" class="zoom"><i class="fa fa-search-plus" aria-hidden="true"></i></a>
												</div>
											</div>
										</li>
									<?php } ?>
							...
							<div class="col-md-6  col-sm-6 col-xs-6 right">
								<div class="border">
									...
									<p><b>Giá:</b> <?php the_field('gia_sp');?></p>
		...
		<div class="popup-content">
			...
			<form action="">
				<div class="info-car">
					...
					<div class="row">
						<div class="col-4">
							<img class="img-fluid" src="<?php echo $featured_img_url;?>" alt="<?php the_title();?>">
						</div>
						<div class="col-8">
							<p> <b class="name"><?php the_title();?></b></p>
							<p class="price"> <b>Giá:</b> <?php the_field('gia_sp');?></p>
							<p><b>Số chỗ:</b> <?php the_field('cho_ngoi');?></p>
							<p><b>Thương hiệu:</b> <?php the_field('thuong_hieu');?></p>
						</div>
					</div>
